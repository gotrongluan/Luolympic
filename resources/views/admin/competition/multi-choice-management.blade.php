...
@php
	$title = $page_name = 'Câu trắc nghiệm cho vòng ' . $round_val . ', lớp ' . $class;
@endphp
@section('title-page')
	{!! $title !!}
@stop
...
@section('breadcrumb')
	...
	@endif
	<li class="active">Câu trắc nghiệm</li>
@stop
@section('stylesheets')
...
<div class="row">
	<div class="col-sm-12">
		<div class="white-box">
			...
			<p class="text-muted"><code>. Câu hỏi trắc nghiệm cho vòng {!! $round_val !!}, lớp {!! $class !!}</code></p>
			<form id="multi-choice-form" class="form-horizontal form-material" method="post" action="{!! url('admin/process-new-multi-choice') !!}">
				...
				<div class="form-group">
					...
					<div class="col-md-3 col-md-12">
						@php
							$answering = ['A' => "", 'B' => "", 'C' => "", 'D' => ""];
							if ( isset( $answer ) )
								$answering[$answer] = "selected";
						@endphp
						<select name="answer" class="form-control form-control-line">
